          ...
          <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
            <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-LightGray md:text-sm">Boulder</span>
              </div>
              <div className="flex justify-between items-center">
            ...
            <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-LightGray text-sm">EF</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="md:text-base">Phone:</span>
                <span className="text-LightGray text-sm">55 (55) 5555555</span>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        <div className="flex flex-col items-center justify-center">
          ...
          <a
            ...
            target="_blank"
            href="https://efurness.github.io/portfolio-ellen-next-js"
          >
