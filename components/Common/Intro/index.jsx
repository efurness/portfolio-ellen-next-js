  ...
  return (
    <>
      ...
      <div className='header z-50 absolute ${bgColor} backdrop-blur-sm inset-y-0 h-48 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4'>
        <Image className='w-20 h-20 rounded-full' src={Ellen} alt='profile picture' />
        <div className='flex flex-col items-center justify-center'>
          <span className='${textColor} text-base font-bold break-normal'>{NAME}</span>
          <span className='text-sm ${textColors} text-center mt-2'>{DESIGNATION}</span>
        </div>
      </div>
